# from https://gist.github.com/phughes/4462966/raw/158125dc08a525b7890a1fbe6c598de78a8b1789/image.py
...
class ImageGroup:
    ...
    def output(self, filename, extension, prefix):
        return args.format % {'prefix':prefix, 'identifier':mungedName(filename), 'filename':filename, 'extension':extension}
...
source = path.expanduser(args.source)
iterator_png = glob.iglob(path.join(source, '*.png'))
...
for fullpath in imerge(iterator_png, iterator_jpg):
...
for key in all_files:
    ...
    output += warnings
    output += image_group.output(key, image_group.extension, args.prefix)
